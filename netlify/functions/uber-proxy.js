...
// v9.5: добавлены fmt=G, fmt=H (orgId на верхнем уровне request)
  ...
  try {
    ...
    if (action === 'performance-data') {
      ...
      if (fmt === 'A') {
        ...
        return { statusCode: 400, headers, body: JSON.stringify({ error: 'unknown fmt, try A/B/C/D/E/G/H' }, null, 2) };
      }
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v9.5 - performance-data fmt=G/H',
        actions: {
