...
// v9.8: fmt=N/O/P — flat + snake_case (Uber хочет report_requests)
  ...
  try {
    ...
    if (action === 'performance-data') {
      ...
      if (fmt === 'A') {
        ...
        return { statusCode: 400, headers, body: JSON.stringify({ error: 'unknown fmt, try A/B/C/D/E/G/H/I/J/K/L/M/N/O/P' }, null, 2) };
      }
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v9.8 - fmt=N/O/P (snake_case report_requests)',
        actions: {
