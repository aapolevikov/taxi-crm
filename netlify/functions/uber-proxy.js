...
// v11.0: fmt=W/X/Y/Z — dimensions как массив ОБЪЕКТОВ (подсказка от Uber: ReadMapCB expect { or n)
  ...
  try {
    ...
    if (action === 'performance-data') {
      ...
      if (fmt === 'A') {
        ...
        return { statusCode: 400, headers, body: JSON.stringify({ error: 'unknown fmt, try A..Z' }, null, 2) };
      }
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v10.0 - fmt=Q..V (more variants)',
        actions: {
