...
// v9.6: добавлены fmt=I, fmt=J (org_id в URL query, filters в body как в transactions)
  ...
  try {
    ...
    if (action === 'performance-data') {
      ...
      if (fmt === 'A') {
        ...
        return { statusCode: 400, headers, body: JSON.stringify({ error: 'unknown fmt, try A/B/C/D/E/G/H/I/J' }, null, 2) };
      }
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v9.6 - fmt=I/J (org_id in URL query)',
        actions: {
