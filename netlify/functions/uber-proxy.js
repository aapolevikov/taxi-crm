...
// v9.1: откат scopes к v8 (новые scopes Uber не выдаёт)
// Per-driver endpoints пробуем со старыми scopes
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v9.1 - per-driver endpoints (old scopes)',
        actions: {
