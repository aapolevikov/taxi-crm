...
// v12.0: fmt=AA/BB/CC/DD/EE/FF — прицельный перебор ИМЕНИ поля внутри dimensions/metrics объекта
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v12.0 - fmt=AA..FF (прицельный перебор имени поля)',
        actions: {
