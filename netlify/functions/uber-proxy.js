...
// v9.2: исправлен performance-data → analytics-data/query
...
// performance: /v1/vehicle-suppliers/analytics-data/query (POST) ← FIXED
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // === 📊 v9.2: PERFORMANCE DATA через analytics-data/query ===
    ...
    return { 
      ...
      headers, 
      body: JSON.stringify({
        message: 'Uber API proxy v9.2 - performance-data via analytics-data/query',
        actions: {
